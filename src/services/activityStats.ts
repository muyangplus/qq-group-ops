...
const log = getLogger("activity-stats");
...
const FONT_FAMILY = "ActivityStatsSans";
...
function defaultHasSystemFont(path: string): boolean {
  try {
...
function defaultReadFontFile(path: string): Uint8Array | undefined {
  try {
