...
export const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    body: () => [
      ...
      "  /menu admin     管理菜单：待审批 / 同步 / 规则 / 审计 / 状态 / 自检",
      "  /menu review    审核操作（群管理员及以上）",
      "  /menu ops       活动运营与导出（群管理员及以上）",
      "  /menu super     超管菜单（仅全局超级管理员）",
      "",
      "说明：",
      "  · 菜单按钮都是指令按钮：点击等价于发送对应指令，权限校验与手输完全一致；",
      "  · 自定义按钮是官方内邀能力，未开通时会自动降级为纯文本菜单，正文里同样列出指令；",
      "  · 群里 @机器人 不带内容、私信里第一次和机器人交互，都会收到主菜单；",
      "  · 需要参数的指令（如 /approve <申请ID>）在菜单正文里给用法，不提供按钮。",
    ],
  },
  {
    name: "testmenu",
  ...
  },
  {
    ...
    body: () => [
      ...
      "  /pending 654321",
      "",
      "输出会列出申请短码（形如 #M7K2Q9）、申请人展示名与入群理由；审批用 /approve、/reject。",
