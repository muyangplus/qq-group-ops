...
禁言解禁、移出 / 拉黑则按官方能力解除对应状态。见 B8。入口菜单口径见 F2。）
...
- [ ] **B1 消息侧的「正则 + 白名单」维度**（P1 · 批次4 · Phase 1 完善）当前消息侧只有关键词命中，
...
- [ ] **B4 文本内容安全 API 接入**（P1 · 批次4 · Phase 2）含误报 / 漏报处理策略。
- [ ] **B5 图片 / 文件 / 链接审核**（P1 · 批次4 · Phase 2）以官方能力为准。
- [ ] **B6 审核日志导出 + 统一脱敏策略**（P1 · 批次4 · Phase 2）活动 CSV 导出已有；
...
- [ ] **F1 群内回复统一 @ 具体发起人**（P1 · F 专项（独立版本 0.13.0） · 横切）**所有群内回复**——操作确认、菜单、反馈、
...
- [ ] **F2 入口菜单默认面向普通成员，管理类入口只在私信暴露**（P1 · F 专项（独立版本 0.13.0） · 横切）
